...
export const COURSES = [
  ...
  {
    level: "Мини-курс",
    title: "Разрешаю тебе бесить",
    desc: "Харизма — это не пуиупу. Курс о том, как перестать гасить себя и начать звучать по-настоящему. Без масок, без извинений за своё присутствие.",
    duration: "Навсегда",
    price: "500 ₽",
    tag: "Мини-курс",
    link: "/course/charisma",
    cover: "https://cdn.poehali.dev/projects/2c2649a4-f97e-4608-8ac1-4bd4de8bd9d6/bucket/93a81fb6-b1ea-4297-b095-339cef5db382.jpg",
  },
  {
    level: "Книга",
    title: "Сила твоего голоса",
