...
export const VIDEOS = [
  ...
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 4", duration: "", views: "", locked: false, youtubeId: "GzJ3_kLw1-c" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 5", duration: "", views: "", locked: false, youtubeId: "BOG0U5Jr5BU" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 6", duration: "", views: "", locked: false, youtubeId: "_oht86Q5hGQ" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 7", duration: "", views: "", locked: false, youtubeId: "MiBtVotpcak" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 8", duration: "", views: "", locked: false, youtubeId: "nPIwJir9Nsw" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 9", duration: "", views: "", locked: false, youtubeId: "RRgKrasvMWE" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 10", duration: "", views: "", locked: false, youtubeId: "hzREhhTNG94" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 11", duration: "", views: "", locked: false, youtubeId: "muDYZ0PxtZM" },
  { category: "Поёт тренер", title: "Анна Артман — живое выступление 12", duration: "", views: "", locked: false, youtubeId: "Lb04KB3LaY8" },
